...
Revision ID: 3eabb5ee5b6f
Revises: 
Create Date: 2024-06-12 13:33:16.693878
...
def upgrade() -> None:
    ...
    op.create_table('products_in_shops',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_shop_product', 'products_in_shops', ['shop_id', 'product_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_shop_product', table_name='products_in_shops')
    op.drop_table('products_in_shops')
